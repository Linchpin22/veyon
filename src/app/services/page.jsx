...
export const metadata = {
  title: 'Services | BlackGiraffe',
  description:
    'Discover the range of digital services offered by BlackGiraffe, including high-end digital product development and innovative solutions.',

  alternates: {
    canonical: 'https://blackgiraffe.in/services',
  },
  ...
  openGraph: {
    ...
    description:
      'Discover the range of digital services offered by BlackGiraffe, including high-end digital product development and innovative solutions.',
    url: 'https://blackgiraffe.in/services',
    type: 'website',
      ...
      <main className="pt-32">
        ...
        <section className="relative text-center px-6 mb-32">
          <div className="absolute inset-0">
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-[#e3f700]/10 rounded-full blur-[120px]" />
          </div>
        ...
        <section className="py-32 border-t border-white/5">
          <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div>
              <div className="inline-block px-4 py-1 rounded-full bg-[#1a1919] text-[#e3f700] text-sm font-bold mb-6">
                ENGINEERING
              </div>
            ...
            <div className="bg-[#262626]/40 backdrop-blur-xl p-8 rounded-xl border border-white/10 shadow-[0_0_25px_rgba(227,247,0,0.1)]">
              ...
              <div className="flex flex-wrap gap-3 text-sm">
                {["Next.js", "React", "Node.js", "Tailwind", "PostgreSQL"].map((tech) => (
                  <span
                    key={tech}
        ...
        <section className="py-32 border-t border-white/5">
          ...
          <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-3 gap-8">
            {["Instagram Growth", "Content Design", "Ads Management"].map((item) => (
              <div
                key={item}
        ...
        <section className="py-32 border-t border-white/5">
          <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="bg-[#262626]/40 backdrop-blur-xl h-[400px] rounded-xl border border-white/10" />
          ...
          <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="bg-[#1a1919] p-6 rounded-xl">
                  SaaS Pages
                </div>
                <div className="bg-[#1a1919] p-6 rounded-xl">
                  Sales Funnels
        ...
        <section className="text-center py-32 border-t border-white/5">
          ...
          <button className="bg-[#e3f700] text-black px-10 py-4 rounded-xl font-bold hover:shadow-[0_0_30px_rgba(227,247,0,0.3)]">
            Start a Project
          </button>
        </section>
