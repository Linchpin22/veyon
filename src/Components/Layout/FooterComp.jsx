            ...
            <div className="flex flex-wrap gap-3">
              {[
                ...
                <a
                  ...
                  aria-label={label}
                  className="w-11 h-11 rounded-full bg-[#1f1f1f] flex items-center justify-center text-white hover:bg-yellow-400 hover:text-black transition-all duration-300"
                >
                  {icon}
                </a>
              ))}
            ...
            <ul className="space-y-3 text-xs sm:text-sm uppercase tracking-widest">
              {[
                ...
                <li key={item.name}>
                  ...
                  >
                    <span className="h-[1px] w-0 bg-yellow-400 transition-all duration-300 group-hover:w-4 shrink-0"></span>
                    {item.name}
                  </Link>
                </li>
              ))}
            ...
            <div className="space-y-5">
              ...
              <div className="flex items-start gap-3 group">
                ...
                <div className="flex flex-col min-w-0">
                  ...
                  <a
                    href={`mailto:${Constant.Company.email}`}
                    className="text-white hover:text-yellow-400 transition-colors text-sm break-all"
                  >
            ...
            <div className="flex flex-wrap justify-center sm:justify-end gap-x-6 gap-y-3 text-[10px] sm:text-xs uppercase tracking-widest">
              {[
                ...
                <Link
                  key={href}
                  href={href}
                  className="text-white/50 hover:text-yellow-400 transition-colors whitespace-nowrap"
                >
                  {label}
                </Link>
              ))}
