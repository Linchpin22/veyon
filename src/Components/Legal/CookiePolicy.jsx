      ...
      <header className="pt-48 pb-24 px-8 text-left">
        <div className="max-w-7xl mx-auto">
          ...
          <p className="text-gray-400 text-lg md:text-xl max-w-2xl">
            This policy explains how we use cookies and tracking technologies
            to improve your experience and analyze website performance.
          </p>
        </div>
      </header>
          ...
          <aside className="hidden lg:block lg:col-span-3">
            <div className="sticky top-32 space-y-4">
              ...
              <nav className="flex flex-col gap-4 border-l border-white/10 pl-6">
                <a className="text-[#e3f700] font-bold text-sm">
                  Overview
                </a>
          ...
          <div className="lg:col-span-9 space-y-24">
            ...
            <section className="bg-[#131313] p-12 rounded-xl">
              ...
              <p className="text-gray-400 mb-8 max-w-2xl">
                You can disable cookies through your browser settings or
                manage preferences through our settings portal.
              </p>
            ...
            <section className="border-t border-white/10 pt-8">
              <p className="text-gray-500 text-sm">
                Pixora reserves the right to update this Cookie Policy at any
