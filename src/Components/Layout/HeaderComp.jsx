    ...
    <>
      ...
      >
        <div className="max-w-[1400px] mx-auto px-5 sm:px-8 py-4 flex items-center justify-between">
          ...
          <Link
            href="/pricing"
            className="hidden lg:flex items-center gap-2 bg-yellow-400 text-black px-5 py-2 rounded-full font-bold hover:scale-105 hover:bg-yellow-300 transition-all duration-200 shrink-0"
          >
            <FiTag size={14} />
            Get Pricing
          </Link>
      ...
      >
        {/* Close button */}
        <button
          className="absolute top-5 right-5 w-10 h-10 flex items-center justify-center rounded-lg text-white/60 hover:text-yellow-400 hover:bg-white/10 transition"
          onClick={() => setMenuOpen(false)}
