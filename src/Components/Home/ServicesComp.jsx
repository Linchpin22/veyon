  ...
  return (
    <section className="bg-[#0e0e0e] text-white py-24 px-6 md:px-12 lg:px-24">
      ...
      <div className="max-w-4xl mx-auto text-center mb-20">
        <span className="text-yellow-400 text-xs uppercase tracking-[0.3em] font-bold mb-4 block">
          OUR SERVICES
        </span>
        ...
        <p className="text-gray-400 text-lg">
          ...
          social media content, and digital branding solutions.
        </p>
      </div>
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        {services.map((service, index) => (
          ...
          >
            {/* Icon */}
            <div className="w-14 h-14 rounded-lg bg-[#1f1f1f] flex items-center justify-center mb-6 text-yellow-400 text-2xl group-hover:scale-110 transition">
              {service.icon}
            </div>
