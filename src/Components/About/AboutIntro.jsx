             ...
             <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
               <div className="lg:col-span-7">
                 ...
                 <div className="space-y-6 text-gray-400 text-lg">
                   <p>
                     At Pixora, we believe that the digital world has become too cluttered.
                     We see ourselves as digital architects, stripping away the unnecessary
                     noise to reveal the luminous monolith within your brand's potential.
                   </p>
                   <p>
                     Founded in 2020, we've pivoted away from the agency factory model.
                     We choose depth over volume, craftsmanship over templates, and innovation
                     over the status quo.
                   </p>
                 </div>
               </div>
